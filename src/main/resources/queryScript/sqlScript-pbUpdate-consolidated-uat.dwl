...
---Get LITM from 4106 where BPMCU=1801
    ...
    WHERE  TRIM(X1.BPMCU)='1801' and (( X1.BPEXDJ >= 125008 
    and X1.BPUPMJ >= 125008 AND X1.BPTDAY > 122638) or X1.BPEFTJ >= 125008)
),
...
WHERE TRIM(T1.IBMCU)='1801' AND  (( T4.BPEXDJ >= 125008 and T4.BPUPMJ = 125008
    AND T4.BPTDAY >= 122638) )
