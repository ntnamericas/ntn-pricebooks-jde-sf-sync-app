  ...
  "compositeRequest": flatten(
    [payload] map ((item, index) -> [
      ...
      },
	  {
        ...
        "url": "/services/data/v57.0/query/?q=SELECT id from PricebookEntry where (Pricebook2Id = '@{refPricebook3" ++ index as String ++ ".records[0].Id}' and Product2Id = '@{refProduct2" ++ index as String ++ ".records[0].Id}')"
      },
      {
        "method": "GET",
